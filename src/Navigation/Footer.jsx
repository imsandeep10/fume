      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-4 mt-6">
            ...
            <a
              ...
              className="hover:opacity-80 transition-opacity"
            >
              <FaTwitter size={28} color="#FFA828" />
            </a>
          </div>
        </div>
        ...
        <div className="">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-2 hover:text-[#FFA828]">
              <FaPhoneAlt size={20} color="#FFA828" />
              <a href="tel:+9779857075504" className="hover:underline block">
                9857077828, 9762345120
              </a>
            </li>
            <li className="flex items-start gap-2 hover:text-[#FFA828]">
              <IoMdMail size={20} color="#FFA828" />
              <a
          ...
          <Link href={"/contact"}>
            <Button className="mt-6 text-sm text-white px-4 py-2 rounded-full transition duration-200 bg-[#32241B] w-52 shadow-md hover:bg-[#EBA747]  hover:text-[#32241B]">
              Get Directions
            </Button>
          </Link>
        </div>
