    ...
    <section className="relative py-20 overflow-hidden bg-[#FFFCF9]">
      <div className="text-center max-w-2xl mx-auto mb-10">
        ...
        <p className="mt-2 text-[#7D5336]">
          Secure your seat in our professional training programs and start your
          journey as a skilled barista, bartender, or chef
        </p>
      </div>
      <div className="max-w-lg mx-auto relative bg-[#F5EBDD40] backdrop-blur-md border border-white/40 rounded-2xl shadow-2xl p-6 sm:p-8 z-10">
        <Formik
            ...
            <Form className="flex flex-col gap-4 text-[#3D220F]">
              ...
              <div className="relative">
                <button
                  ...
                  onClick={() =>
                    setFieldValue("showCourseOptions", !values.showCourseOptions)
                  }
                >
              ...
              <div className="flex flex-col gap-2">
                ...
                <label className="flex items-center gap-2">
                  <Field type="checkbox" name="level" value="Intermediate" />
