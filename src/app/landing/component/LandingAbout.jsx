    ...
    <section id="about" className="py-16 px-6 bg-white">
      <article className="w-10/12 mx-auto grid md:grid-cols-2 gap-20 items-center py-6">
        <div className="flex flex-col gap-4 pt-24 -mt-28">
          ...
          <nav>
            <Link href={`/about`}>
              <Button className="inline-block rounded-full bg-transparent border border-[#3D220F] px-6 py-2 text-[#3D220F] hover:bg-[#3D220F] hover:text-white transition delay-100">
                Learn more →
              </Button>
            </Link>
          </nav>
        ...
        <figure className="relative flex justify-end items-center top-4 ml-8">
          ...
          <Image
            ...
            className="absolute -top-14 -left-16 
                       sm:-top-12 sm:-left-10
                       md:-top-14 md:-left-18
                       lg:-top-12 lg:ml-42 lg:-left-20"
          />
          <Image
            src="/bean2.png"
            ...
            className="absolute -bottom-18 -right-10
                       sm:-bottom-14 sm:-right-8
                       md:-bottom-16 md:-right-12
